...
const mapStateToProps = (state) => {
    return {
        item: state.adminState.itemState,
    };
};
        ...
        <Container maxWidth="md">
            <Grid container spacing={0}>
                <Grid item xs={12} sm={6} md={6} lg={6}>
                    <Card>
                        <CardMedia component="img" height="250" image={props.item.image} alt="" />
            ...
            <Box sx={{ mb: 2 }}>
                <Button type="submit" variant="outlined" color="primary" sx={{ ...style }} endIcon={<SendIcon />} onClick={handleDish}>
