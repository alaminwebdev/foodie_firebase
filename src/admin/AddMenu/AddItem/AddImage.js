...
const mapStateToProps = (state) => {
    return {
        itemImage: state.adminState.itemState.image,
    };
};
...
const AddImage = (props) => {
    ...
    const handleUpload = () => {
        ...
        if (image !== null) {
            ...
            console.log("Please upload a image first!");
        }
    };
    ...
    return (
        <Container maxWidth="md">
            ...
            >
                ...
                <Box>
                    <Button variant="outlined" component="span" disabled={image ? false : true} onClick={handleUpload} endIcon={Boolean(props.itemImage) ? <CheckIcon /> : <SendIcon />}>
            ...
            <Box sx={{ mb: 2 }}>
                <Button type="submit" variant="outlined" color="primary" sx={{ ...style }} endIcon={<SendIcon />} onClick={nextStep}>
