        ...
        <Container maxWidth="xl">
            <Grid container sx={{ my: 5 }} spacing={2}>
                ...
                <Grid item xl={6} lg={6} md={6} sm={12} sx={{ textAlign: "center", alignSelf: "center" }}>
                    <Box>
                        <Control ingredientAdd={addIngredient} ingredientRemove={removeIngredient} price={props.totalPrice} purchasable={props.purchasable} modalOpen={handleClose} />
                    </Box>
                </Grid>
            </Grid>
            <Modal sx={{ overflowY: "scroll" }} aria-labelledby="transition-modal-title" aria-describedby="transition-modal-description" open={modalOpen} onClose={handleClose} closeAfterTransition>
                <Fade in={modalOpen}>
                    <Box sx={style}>
                        <Summery modalClose={handleClose} totalPrice={props.totalPrice} ingredients={props.ingredients} ingredientPrice={props.ingredientPrice} handleCheckout={handleCheckout} />
                    </Box>
                </Fade>
            </Modal>
        </Container>
