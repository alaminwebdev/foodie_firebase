...
const SlideText = (props) => {
    ...
    return (
        ...
        <motion.div key={props.dishIndex.id} initial="initial" animate="animate" variants={stagger}>
            ...
            <motion.div variants={fadeInUp}>
                <Typography variant="h2" sx={{ fontWeight: 600, ml: 0, color: "#007FFF" }}>
                    {dishIndex.name}
                </Typography>
            </motion.div>

            <motion.div variants={fadeInUp}>
                <Typography variant="subtitle2" sx={{ pr: "30%" }}>
                    {dishIndex.description}
                </Typography>
            </motion.div>

            <motion.div variants={fadeInUp}>
                <Button variant="contained" sx={{ mt: 2, bgcolor: "#007FFF" }} endIcon={<AddShoppingCartIcon />}>
                    Add to cart
                </Button>
            </motion.div>
        </motion.div>
